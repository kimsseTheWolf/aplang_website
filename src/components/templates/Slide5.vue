<template>
  ...
  <ContentBlock>
    <template #content>
      ...
      <p>
        The good news is that recognizing these shortcomings is the first step toward crafting better strategies. Schools, families, and communities can adopt new approaches that are more engaging, empathetic, and effective at keeping teens safe. Here are some of my little advice and simple "helper guides" for you when encountering these issues. Choose who you are, and everything is ready for you right there :D!
      </p>
    </template>
  </ContentBlock>
  ...
  <ContentBlock>
    <template #content>
      <div class="card-grid">
        <ExpandableCard>
          <template #default>
            <img src="/-student-.svg" width="48px"/>
            <h3>Students</h3>
          </template>
          <template #sidebar>
        ...
        <ExpandableCard>
          <template #default>
            <img src="/-teacher-.svg" width="48px"/>
            <h3>Teachers</h3>
          </template>
          <template #sidebar>
  ...
  <ContentBlock>
    <template #content>
      <div class="center-content">
        ...
        <p>
          Your teachers and parents are always there for you! If you really need help and don't know what to do, it is always a good option to ask them for help first! Here are some useful sites you can check out!
        </p>
        <CardBlock :cards="[
          0,1,2,3
        ]" >
          <template #card-0>
            <div style="text-align: left;">
              <p><strong>SAMHSA’s National Helpline</strong></p>
              <p>
                🔗 https://www.samhsa.gov/find-help/national-helpline<br>

                📞 1-800-662-HELP (4357)
              </p>
              <p>Anyone struggling with substance use, mental health issues, or need treatments.</p>
            </div>
          </template>
          <template #card-1>
            <div style="text-align: left;">
              <p><strong>988 Suicide & Crisis Lifeline (Also applied to Drug abuses and substances crisis)</strong></p>
              <p>
                🔗 https://988lifeline.org/<br>

                📞 Dial 998
              </p>
              <p>Crisis support, including drug-related issues, and drug-caused emotional distress.</p>
            </div>
          </template>
          <template #card-2>
            <div style="text-align: left;">
              <p><strong>National Institute on Drug Abuse (NIDA)</strong></p>
              <p>
                🔗 https://nida.nih.gov/
              </p>
              <p>Provides in-depth researches and news about drugs and drug-related topics. Good for learning and prevention.</p>
            </div>
          </template>
          <template #card-3>
            <div style="text-align: left;">
              <p><strong>Get Smart About Drugs (DEA)</strong></p>
              <p>
                🔗 https://www.getsmartaboutdrugs.gov/
              </p>
              <p>Provide drug trends, prevention tips, and it also provides tools for school and parents to educate their children and teens about drugs</p>
            </div>
          </template>
        </CardBlock>
      </div>
